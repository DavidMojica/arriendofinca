<?php
    ...
    if($page > 0){
        ...
        $s_stmt->execute();
        $numero_resultados = $s_stmt->rowCount();
...
<header>
    ...
    <h2>Resultados de la busqueda</h2>
        ...
        <section id="busqueda_relacionada" class="busquedas">
            <?php
                #pagination
                $s_numero_items_por_pagina = 1;
                $s_page   = isset($_GET['s_page']) ? $_GET['s_page'] : 1;
                $s_offset = ($s_page -1) * $s_numero_items_por_pagina;
                ...
                AND arriendo_o_venta = :id_aov and tbl_municipio.id_estado = :id_estado and id_municipio_ubicacion != :id_dif_mpio";
                ...
                LEFT JOIN tbl_municipio ON tbl_inmueble.id_municipio_ubicacion = tbl_municipio.id_municipio WHERE id_tipo_inmueble = :id_tipo_inmueble 
                AND arriendo_o_venta = :id_aov and tbl_municipio.id_estado = :id_estado LIMIT :offset, :lim";
                ...
                $stmt->bindParam(':lim',$s_numero_items_por_pagina, PDO::PARAM_INT);
                ...
                <div class="pagination"> 
                    <?php #SISTEMA DE PAGINACIÓN
                        $s_num_paginas = ceil($s_numero_resultados / $s_numero_items_por_pagina);
                        $s_visibleLinks = 5;
